...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        // general info
        Info info = new Info()
                .title("Chatterbox.uz API-lar")
                .version("1.0.0")
                .description("Quyida Chatterbox.uz loyihasi uchun API hujjatlar tagdim qilingan.")
                .contact(new Contact()
                        .name("Sukhrob")
                        .email("sukhrobkholdorov999@gmail.com")
                        .url("https://t.me/rBaPmKaS")
                )
                .license(new License()
                        .name("Videohub.uz")
